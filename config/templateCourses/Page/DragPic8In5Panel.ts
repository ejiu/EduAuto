class DragPic8In5Panel extends PageBase {
    public constructor() {
        super();
        this.skinName = "DragPic8In5Skin";   
        this.jsonData = RES.getRes("page_info_json");
        this.interactiveCount = this.jsonData['drag_info_8In5']['items'].length;
        var tImg:eui.Image;
        ...
        {      
            ...
            tImg.source = this.jsonData['drag_info_8In5']['items'][i].res_path;

            tBgImg = this.getInteractBgImg(i);
            tBgImg.source = this.jsonData['drag_info_8In5']['items'][i].res_path; 
            tBgImg.x = tImg.x;
            tBgImg.y = tImg.y;
            ...
            if(this.jsonData['drag_info_8In5']['items'][i].isright)
            {
                this.rightNum++;
            }
        }   
    ...
    private dealMouseupMsg(tTargetIndex:number, tPosX:number, tPosY:number)
    {
        ...
        if(this.dragCount < this.rightNum) 
        {
            ...
            isHit4 = GameMaths.hasHit(this.resultPos_4.x-this.resultPos_4.anchorOffsetX,this.resultPos_4.y-this.resultPos_4.anchorOffsetY,this.resultPos_4.width,this.resultPos_4.height, tPosX, tPosY); 
        }
        if(isHit0 && this.existNum[0]){
            ...
            isHit = 3;
        }else if(isHit4 && this.existNum[4]){
            this.existNum[4] = false;
            isHit = 4;
        }
    ...
    {  
        ...
        {    
            tImg = this.getInteractImg(i);              
            CheckAnswerPanel.checkAnswer().showResult(new egret.Point(tImg.x,tImg.y),this.jsonData['drag_info_8In5']['items'][i].isright);  
        }   
    }
