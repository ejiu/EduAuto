class PlaySoundPanel2 extends PageBase {
    public constructor() {
        super();
        this.skinName = "PlaySoundSkin2";
        this.farmSound = RES.getRes("PK007_2_mp3");
        if(null == this.farmSound)
        {
            RES.getResAsync("PK007_2_mp3", this.onResSoundFarmLoaded, this );
        }
    }
